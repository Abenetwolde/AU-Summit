                    ...
                    <Card className="bg-white border-0 shadow-sm">
                        ...
                        <CardContent className="space-y-3">
                            <div className="flex items-center gap-2">
                                ...
                                <label className="text-sm text-gray-600 font-medium">Items match declaration</label>
                            </div>
                            <div className="flex items-center gap-2">
                                ...
                                <label className="text-sm text-gray-600 font-medium">Serial Numbers Verification</label>
                            </div>
                        </CardContent>
                    </Card>
                </div>
