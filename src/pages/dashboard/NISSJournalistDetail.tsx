...
import { User, Phone, FileText, Plane, Briefcase, Check, X, ShieldCheck, Download } from 'lucide-react';
                ...
                <div className="lg:col-span-4 space-y-6">
                    ...
                    <Card className="bg-white border-0 shadow-sm">
                        ...
                        <CardContent className="space-y-3">
                            <div className="flex items-center gap-2">
                                <input type="checkbox" disabled={isReadOnly} className="rounded border-gray-300 text-blue-600 focus:ring-blue-500" />
                                <label className="text-sm text-gray-600 font-medium">Passport validity &gt; 6 months</label>
                            </div>
                            <div className="flex items-center gap-2">
                                <input type="checkbox" defaultChecked disabled={isReadOnly} className="rounded border-gray-300 text-blue-600 focus:ring-blue-500" />
