...
import { Search, RefreshCw, BadgeCheck, UserX } from 'lucide-react';
...
export function CustomsAccreditedJournalists() {
        ...
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <h2 className="text-3xl font-bold font-sans text-gray-900">Accredited Journalists (Customs)</h2>
            ...
            {/* Stats Cards - Only 2 cards for Customs */}
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <Card className="bg-green-100/50 border-0 shadow-sm">
                    <CardContent className="p-6 flex items-center gap-4">
                        ...
                        <div>
                            <p className="text-sm font-medium text-gray-600">Customs Approved</p>
                ...
                <Card className="bg-red-100/50 border-0 shadow-sm">
                    <CardContent className="p-6 flex items-center gap-4">
                        ...
                        <div>
                            <p className="text-sm font-medium text-gray-600">Customs Rejected</p>
                    ...
                    <table className="w-full caption-bottom text-sm">
                        <thead className="[&_tr]:border-b">
                            <tr className="border-b transition-colors hover:bg-muted/50 data-[state=selected]:bg-muted">
                                ...
                                <th className="h-12 px-4 text-center align-middle font-medium text-muted-foreground">IMMIGRATION AND<br />CITIZENSHIP</th>
                                <th className="h-12 px-4 text-center align-middle font-medium text-muted-foreground">INSA</th>
                                <th className="h-12 px-4 text-center align-middle font-medium text-muted-foreground">NISS</th>
