...
export function NISSJournalistList() {
    ...
    return (
        <div className="space-y-6">
            <div>
                <h2 className="text-3xl font-bold font-sans text-gray-900">Journalists List (NISS)</h2>
                            ...
                            {filteredData.map((journalist, index) => {
                                ...
                                return (
                                    <tr key={journalist.id} className="border-b transition-colors hover:bg-muted/50">
                                        ...
                                        <td className="p-4 align-middle">
                                            <Button variant="outline" size="sm" className="hidden lg:flex h-8 text-blue-500 border-blue-200 hover:bg-blue-50 hover:text-blue-700 font-bold" onClick={() => navigate(`/niss/journalists/${journalist.id}`)}>
