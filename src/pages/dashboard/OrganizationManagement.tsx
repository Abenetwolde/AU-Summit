    ...
    return (
        <div className="space-y-6">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                    <h2 className="text-2xl md:text-3xl font-bold font-sans text-gray-900">Organization Management</h2>
                    <p className="text-sm text-muted-foreground">Manage partner organizations and their access.</p>
                </div>
                <Button onClick={() => setIsCreateModalOpen(true)} className="gap-2 bg-blue-600 hover:bg-blue-700 w-full sm:w-auto">
            ...
            <Card className="bg-white border-0 shadow-sm">
                <CardContent className="p-6">
                    <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
                        ...
                        <Button variant="outline" className="gap-2 border-gray-200 text-gray-600 w-full md:w-auto">
