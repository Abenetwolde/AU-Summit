...
export function NISSAccreditedJournalists() {
        ...
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <h2 className="text-3xl font-bold font-sans text-gray-900">Accredited Journalists (NISS)</h2>
            ...
            {/* Stats Cards - Only 2 cards for NISS */}
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <Card className="bg-green-100/50 border-0 shadow-sm">
                    <CardContent className="p-6 flex items-center gap-4">
                        ...
                        <div>
                            <p className="text-sm font-medium text-gray-600">NISS Approved</p>
                ...
                <Card className="bg-red-100/50 border-0 shadow-sm">
                    <CardContent className="p-6 flex items-center gap-4">
                        ...
                        <div>
                            <p className="text-sm font-medium text-gray-600">NISS Rejected</p>
