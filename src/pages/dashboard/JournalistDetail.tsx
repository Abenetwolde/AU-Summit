...
import { User, Phone, FileText, Plane, Briefcase, Check, X, ShieldCheck, Download, ChevronLeft } from 'lucide-react';
...
export function JournalistDetail() {
    ...
    if (!journalist) return <div className="p-8 text-center">Journalist not found</div>;
