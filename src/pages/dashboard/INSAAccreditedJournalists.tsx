...
export function INSAAccreditedJournalists() {
        ...
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <h2 className="text-3xl font-bold font-sans text-gray-900">Accredited Journalists (INSA)</h2>
            ...
            {/* Stats Cards - Only 2 cards for INSA */}
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <Card className="bg-green-100/50 border-0 shadow-sm">
                    <CardContent className="p-6 flex items-center gap-4">
                        ...
                        <div>
                            <p className="text-sm font-medium text-gray-600">INSA Approved</p>
                ...
                <Card className="bg-red-100/50 border-0 shadow-sm">
                    <CardContent className="p-6 flex items-center gap-4">
                        ...
                        <div>
                            <p className="text-sm font-medium text-gray-600">INSA Rejected</p>
                    ...
                    <table className="w-full caption-bottom text-sm">
                        ...
                        <tbody className="[&_tr:last-child]:border-0">
                            {paginatedData.map((journalist, index) => {
                                ...
                                const nissStatus = index % 2 === 0 ? 'Approved' : 'Pending';
