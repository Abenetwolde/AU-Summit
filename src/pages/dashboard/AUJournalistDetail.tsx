...
import { User, Phone, FileText, Plane, Briefcase, Printer, ShieldCheck, Download } from 'lucide-react';
...
export function AUJournalistDetail() {
    const { id } = useParams();
                    ...
                    <Card className="bg-white border-0 shadow-sm">
                        <CardHeader>
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    <h3 className="font-bold text-gray-900">Badge Printing</h3>
                                    <p className="text-xs text-gray-500 leading-tight">Print event badge for this journalist.</p>
                                </div>
                            </div>
                        </CardHeader>
                        <CardContent className="space-y-4">
                            <div className="bg-blue-50 p-3 rounded-md text-sm text-blue-800 flex gap-2">
                                <div className="bg-blue-200 rounded-full w-5 h-5 flex items-center justify-center text-[10px] font-bold shrink-0">i</div>
                                Journalist has been approved for accreditation.
                            </div>
                            ...
                            <Button
                                ...
                                onClick={async () => {
                                    toast.promise(sendApprovalEmail(journalist.fullname), {
                                        ...
                                        success: 'Credentials sent to ' + journalist.fullname,
                                        error: 'Failed to send email'
                                    });
                                }}
                            >
                                <Mail className="h-4 w-4 mr-2" /> Send Credentials
                            </Button>
                    ...
                    <Card className="bg-white border-0 shadow-sm">
                        ...
                        <CardContent className="space-y-3">
                            <div className="flex items-center gap-2">
                                ...
                                <label className="text-sm text-gray-600 font-medium">Passport validity &gt; 6 months</label>
                            </div>
                            <div className="flex items-center gap-2">
                                <input type="checkbox" defaultChecked className="rounded border-gray-300 text-blue-600 focus:ring-blue-500" />
